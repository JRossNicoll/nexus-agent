...
Configuration is stored at `~/.nexus/config.json`. On first run, defaults are created automatically. API keys are set during onboarding — no manual config editing needed.
