        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full pl-10 pr-12 py-3 bg-surface-2 border border-white/[0.08] rounded-xl text-white placeholder-gray-600 text-sm focus:outline-none focus:border-[#ff3333]/50 focus:ring-2 focus:ring-[#ff3333]/20"
            />
            <button
              type="button"
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-[#cc2222] to-[#ff3333] text-white rounded-xl text-sm font-medium hover:from-[#ff3333] hover:to-[#ff5555] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#ff3333]/20"
          >
